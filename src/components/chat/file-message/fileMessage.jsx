...
import { CloudinaryImage, CloudinaryFile } from "@cloudinary/url-gen";
...
const FileMessage = ({ file, me }) => {
    ...
    useEffect(() => {
        ...
        if (type === "IMAGE") {
            ...
            //const m = new CloudinaryFile(public_id, { cloudName: process.env.REACT_APP_CLOUD_NAME }).createCloudinaryURL({addFlag:'attachment'})
            //console.log(m)
            setLink(path)
        }
    }, [type]);
